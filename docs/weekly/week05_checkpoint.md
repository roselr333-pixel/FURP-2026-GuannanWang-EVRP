...
Each script writes its evidence to `src/results/*.txt`; benchmark instance files are in `src/instances/`. Full environment details are in `docs/reference/env_record.md`.
